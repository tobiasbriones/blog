  ...
  <div class="article">
    ...
    <ul>
      ...
      <li>
        ...
        <ul>
          <li>
            <a href="#generic-templates">
              Generic Templates
            </a>
          </li>
          <li>
            <a href="#how-i-homogenized-my-previous-article">
              How I Homogenized My Previous Article
            </a>
          </li>
          <li>
            <a href="#check-the-commits">
              Check the Commits
            </a>
          </li>
          <li>
            <a href="#do-not-use-plurals">
              Do not Use Plurals
            </a>
          </li>
        </ul>
      ...
      <li>
        <a href="#how-i-applied-cohesion-to-this-same-article">
          How I Applied Cohesion to This Same Article
        </a>
        <ul>
          <li>
            <a href="#recursive-fun-fact">
              Recursive Fun Fact
            </a>
          </li>
        </ul>
      ...
      <li>
        <a href="#open-graph-cover">
          Open Graph Cover
        </a>
        <ul>
          <li>
            <a href="#we-should-check-out-the-pipe-on-the-home-value-as-well">
      ...
      <li>
        <a href="#i-am-infinitely-thankful">
