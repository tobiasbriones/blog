  ...
  <div class="article">
    ...
    <ul>
      <li>
        ...
        <ul>
          <li>
            <a href="#data-driven-organization">
              Data-Driven Organization
            </a>
          </li>
          <li>
            <a href="#the-role-of-the-cio">
              The Role of the CIO
            </a>
          </li>
          <li>
            <a href="#watch-out-fake-friends">
      ...
      <li>
        ...
        <ul>
          ...
          <li>
            <a href="#predictive-analysis">
              Predictive Analysis
            </a>
          </li>
          <li>
            <a href="#prescriptive-analysis">
      ...
      <li>
        <a href="#power-bi-overview">
          Power BI Overview
        </a>
        <ul>
          <li>
            <a href="#available-platforms">
              Available Platforms
            </a>
          </li>
          <li>
          ...
          <li>
            ...
            <ul>
              <li>
                <a href="#common-data-transformations">
