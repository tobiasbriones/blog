...
<figure>
    <img src="pi-day-2024-03-14.png" alt="Pi Day (2024/03/14)" />
...
<figure>
    <div class="a16-9">
        <img src="sum-and-product-types.svg" alt="Sum and Product Types" />
    </div>
    <figcaption>Sum and Product Types</figcaption>
</figure>
...
<div class="header user-select-none headerless">
    ...
    <div class="menu">
        ...
        <button type="button" data-code="newtype R = R Int  -- [0, 255]
newtype G = G Int  -- [0, 255]
newtype B = B Int  -- [0, 255]

data ColorComponent = Red R &vert; Green G &vert; Blue B
...
<div class="abstract">Expressing Math Concepts like ADTs in Functional Languages</div>

<figcaption>Defining Sum and Product Types in Haskell</figcaption>
</figure>
