...
<nav>
  ...
  <div class="article">
    ...
    <ul>
      <li>
        <a href="#previous-article-operations">
          Previous Article Operations
        </a>
      </li>
      <li>
        <a href="#development-of-a-cli-tool">
          Development of a CLI Tool
        </a>
        <ul>
          <li>
            <a href="#kotlin-and-fp">
              Kotlin and FP
            </a>
          </li>
          <li>
          ...
          <li>
            <a href="#migration-from-github-pages-to-netlify">
      ...
      <li>
        <a href="#the-future-is-swam">
          The Future is SWAM
        </a>
      </li>
      <li>
        <a href="#beginning-of-the-standard-platform-automation">
