---
permalink: sar-hn-_-sales-tax-overview-2023-08-28
title: "SAR HN: Sales Tax Overview (2023/08/28)"
description: "I took the SAR course on sales tax (ISV) in Honduras. I'll cover the insights and information I gathered as an introductory record of what I experienced in this activity."
ogimage: ""
---
...
<nav>
  ...
  <div class="article">
    ...
    <ul>
      <li>
        <a href="#sales-tax-resources">
          Sales Tax Resources
        </a>
      </li>
      <li>
        <a href="#course-takeaways">
          Course Takeaways
        </a>
        <ul>
          <li>
          ...
          <li>
            <a href="#presenting-a-declaration">
      ...
      <li>
        <a href="#generalities-learned-about-sales-tax-in-honduras">
