---
permalink: how-i-standardized-hyphen-and-pipe-symbols-on-file-names
...
<nav>
  ...
  <div class="article">
    ...
    <ul>
      ...
      <li>
        <a href="#encoding-a-hyphen">
          Encoding a Hyphen
        </a>
        <ul>
          <li>
            <a href="#hyphen-design-analysis">
              Hyphen Design Analysis
            </a>
          </li>
          <li>
            <a href="#hyphen-example">
              Hyphen Example
            </a>
          </li>
        </ul>
      ...
      <li>
        <a href="#encoding-a-pipe">
          Encoding a Pipe
        </a>
        <ul>
          <li>
            <a href="#pipe-design-analysis">
      ...
      <li>
        <a href="#standardizing-hyphens-and-pipes-on-file-names">
