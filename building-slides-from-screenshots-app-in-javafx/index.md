...
<img src="images/building-slides-from-screenshots-app-in-javafx.png" alt="Building Slides from Screenshots App in Javafx"/>
...
<figure>
    <img src="images/photopea-_-editing-the-presentation.png" alt="Photopea: Editing the Presentation" />
    <figcaption>Photopea: Editing the Presentation</figcaption>
</figure>
...
<figure>
    <img src="static/slide.jpg" alt="Slide" />
...
<figure>
    <img src="code-snippet-_-slide-app.png" alt="Code Snippet: Slide App" />
    <figcaption>Code Snippet: Slide App</figcaption>
</figure>
...
<figure>
    <img src="code-snippet-_-fibonacci-sequence.png" alt="Code Snippet: Fibonacci Sequence" />
    <figcaption>Code Snippet: Fibonacci Sequence</figcaption>
</figure>

<figure>
    <img src="code-snippet-_-uniform-expectation.png" alt="Code Snippet: Uniform Expectation" />
    <figcaption>Code Snippet: Uniform Expectation</figcaption>
</figure>
...
<figure>
    <div class="a16-9">
        <img src="images/codeshot-_-inspecting-video-rendering-race-condition.png" alt="Codeshot: Inspecting Video Rendering Race Condition" />
    </div>
    <figcaption>Codeshot: Inspecting Video Rendering Race Condition</figcaption>
</figure>
...
<figure>
    <img src="images/screenshot-_-fix-oome-commit.png" alt="Screenshot: Fix OOME Commit" />
    <figcaption>Screenshot: Fix OOME Commit</figcaption>
</figure>
...
<figure>
    <img src="images/ai-_-text-selected-via-ocr.png" alt="AI: Text Selected via Ocr" />
    <figcaption>AI: Text Selected via Ocr</figcaption>
</figure>
...
<h5>Presentation: Video Rendering Side Effect Fix</h5>
...
<div class="header user-select-none ">
    ...
    <div class="menu">
        <button type="button" data-path="slides---ep/src/main/java/module-info.java" onclick="onOpenCodeSnippetLink(this)">
    <span class="material-symbols-rounded">
    open_in_new
    </span>
</button>

        <button type="button" data-code="module engineer.mathsoftware.blog.slides {
...
<figcaption>Definition of Application Modules</figcaption>
</figure>
...
<div class="header user-select-none ">
    ...
    <div class="menu">
        <button type="button" data-path="slides---ep/src/main/java/engineer/mathsoftware/blog/slides/ui/package-info.java" onclick="onOpenCodeSnippetLink(this)">
    <span class="material-symbols-rounded">
    open_in_new
    </span>
</button>
...
<figcaption>Main Application Package</figcaption>
</figure>
...
<div class="header user-select-none ">
    ...
    <div class="menu">
        <button type="button" data-path="slides---ep/src/main/java/engineer/mathsoftware/blog/slides/ui/Main.java" onclick="onOpenCodeSnippetLink(this)">
    <span class="material-symbols-rounded">
    open_in_new
    </span>
</button>

        <button type="button" data-code="public class Main extends Application {
...
<figcaption>Initial Hello World App</figcaption>
</figure>
...
<figure>
    <img src="images/scene-builder-_-initial-app-fxml.png" alt="Scene Builder: Initial App Fxml" />
    <figcaption>Scene Builder: Initial App Fxml</figcaption>
</figure>
...
<div class="header user-select-none headerless">
    ...
    <div class="menu">
        ...
        <button type="button" data-code="├── VBox
    ├── MenuBar
        ├── Menu (File)
            ├── MenuItem (New)
...
<figcaption>Initial App Layout Tree</figcaption>
</figure>
...
<div class="header user-select-none ">
    ...
    open_in_new
        ...
        <button type="button" data-code="var root = FXMLLoader.&lt;Parent&gt;load(
...
<figcaption>Loading the FXML Resource</figcaption>
</figure>
...
<div class="header user-select-none ">
    ...
    <div class="menu">
        <button type="button" data-path="slides---ep/src/main/java/engineer/mathsoftware/blog/slides/ui/AppController.java" onclick="onOpenCodeSnippetLink(this)">
    <span class="material-symbols-rounded">
    open_in_new
    </span>
</button>

        <button type="button" data-code="public class AppController {
    @FXML
...
<figcaption>Initial Application Controller</figcaption>
</figure>
...
<div class="header user-select-none ">
    ...
    <div class="menu">
        <button type="button" data-path="slides---ep/src/main/java/engineer/mathsoftware/blog/slides/data/ImageItem.java" onclick="onOpenCodeSnippetLink(this)">
    <span class="material-symbols-rounded">
    open_in_new
    </span>
</button>

        <button type="button" data-code="public record ImageItem(String filename, Image image) {
    @Override
    public int hashCode() {
...
<figcaption>Definition of an Application Image Item with Name and Image</figcaption>
</figure>
...
<div class="header user-select-none ">
    ...
    <div class="menu">
        <button type="button" data-path="slides---ep/src/main/java/engineer/mathsoftware/blog/slides/data/DataRepository.java" onclick="onOpenCodeSnippetLink(this)">
    <span class="material-symbols-rounded">
    open_in_new
    </span>
</button>

        <button type="button" data-code="public interface DataRepository {
...
<figcaption>Application Data API</figcaption>
</figure>
...
<div class="header user-select-none ">
    ...
    open_in_new
        ...
        <button type="button" data-code="public final class Data {
...
<figcaption>Application Data Filters</figcaption>
</figure>
...
<div class="header user-select-none ">
    ...
    open_in_new
        ...
        <button type="button" data-code="public class LocalDataRepository implements DataRepository {
...
<figcaption>Implementation of "DataRepository" on "LocalDataRepository"</figcaption>
</figure>
...
<figure>
    <img src="images/master-pane.png" alt="Master Pane" />
    <figcaption>Master Pane</figcaption>
</figure>
...
<div class="header user-select-none ">
    ...
    open_in_new
        ...
        <button type="button" data-code="private static final String DATA_ROOT = &quot;data&quot;;
...
<figcaption>Members of "AppController"</figcaption>
</figure>
...
<div class="header user-select-none ">
    ...
    open_in_new
        ...
        <button type="button" data-code="@FXML
public void initialize() {
...
<figcaption>Initialization of "AppController"</figcaption>
</figure>
...
<div class="header user-select-none ">
    ...
    open_in_new
        ...
        <button type="button" data-code="private void handleError(IOException e) {
...
<figcaption>Other Methods</figcaption>
</figure>
...
<figure>
    <img src="images/dragging-files.png" alt="Dragging Files" />
    <figcaption>Dragging Files</figcaption>
</figure>
...
<figure>
    <img src="images/files-updated.png" alt="Files Updated" />
    <figcaption>Files Updated</figcaption>
</figure>
...
<figure>
    <img src="images/drag-canceled-.-invalid-files.png" alt="Drag Canceled . Invalid Files" />
    <figcaption>Drag Canceled . Invalid Files</figcaption>
</figure>
...
<figure>
    <img src="images/drag-canceled.png" alt="Drag Canceled" />
    <figcaption>Drag Canceled</figcaption>
</figure>
...
<figcaption>Drag Event Implementations</figcaption>
</figure>
...
<div class="header user-select-none ">
    ...
    <div class="menu">
        <button type="button" data-path="slides---ep/src/main/java/engineer/mathsoftware/blog/slides/ui/ImageItemCell.java" onclick="onOpenCodeSnippetLink(this)">
    <span class="material-symbols-rounded">
    open_in_new
    </span>
</button>

        <button type="button" data-code="class ImageItemCell extends ListCell&lt;ImageItem&gt; {
    interface Listener {
...
<figcaption>Implementation of the Cell Items for the List View</figcaption>
</figure>
...
<div class="header user-select-none ">
    ...
    open_in_new
        ...
        <button type="button" data-code="@FXML private ListView&lt;ImageItem&gt; imageList;
...
<figcaption>Integration of the List View and Data Repository into the App Controller</figcaption>
</figure>
...
<figure>
    <img src="images/clear-all.png" alt="Clear All" />
...
<div class="header user-select-none ">
    ...
    open_in_new
        ...
        <button type="button" data-code="@FXML private Parent view;
...
<figcaption>Implementation of Deleting Actions (the "Danger Zone")</figcaption>
</figure>
...
<figure>
    <img src="images/listview-drag-and-drop-animation.gif" alt="ListView Drag and Drop Animation" />
    <figcaption>ListView Drag and Drop Animation</figcaption>
</figure>
...
<div class="header user-select-none ">
    ...
    open_in_new
        ...
        <button type="button" data-code="setDragAndDropItemSort();
...
<figcaption>Updating the Init Method of "ImageItemCell"</figcaption>
</figure>
...
<div class="header user-select-none ">
    ...
    open_in_new
        ...
        <button type="button" data-code="private void setDragAndDropItemSort() {
...
<figcaption>Drag and Drop Events Needed</figcaption>
</figure>
...
<div class="header user-select-none ">
    ...
    open_in_new
        ...
        <button type="button" data-code="private void onDragDetected(MouseEvent event) {
    var item = getItem();
...
<figcaption>Drag Event Implementations to Rearrange a List Cell</figcaption>
</figure>
...
<div class="header user-select-none ">
    ...
    open_in_new
        ...
        <button type="button" data-code="private final ObservableList&lt;ImageItem&gt; images;
...
<figcaption>Setting up the App Controller for the "onArrange" Event</figcaption>
</figure>
...
<div class="header user-select-none ">
    ...
    <div class="menu">
        <button type="button" data-path="slides---ep/src/main/resources/app.css" onclick="onOpenCodeSnippetLink(this)">
    <span class="material-symbols-rounded">
    open_in_new
    </span>
</button>

        <button type="button" data-code=".cell {
    -fx-border-width: 2px;
...
<figcaption>CSS Styles for Dragging a List Cell into Another Cell</figcaption>
</figure>
...
<div class="header user-select-none ">
    ...
    open_in_new
        ...
        <button type="button" data-code="scene.getStylesheets().add(
...
<figcaption>Loading CSS Styles into the App</figcaption>
</figure>
...
<div class="header user-select-none ">
    ...
    open_in_new
        ...
        <button type="button" data-code="private URL loadResource(String name) {
...
<figcaption>Method that Loads an App Resource by File Name</figcaption>
</figure>
...
<figure>
    <img src="file-menu-items.png" alt="File Menu Items" />
    <figcaption>File Menu Items</figcaption>
</figure>
...
<div class="header user-select-none ">
    ...
    open_in_new
        ...
        <button type="button" data-code="@FXML private void onAddMenuItemAction() {}
...
<figcaption>Events for Handing the Menu Bar Items</figcaption>
</figure>
...
<figcaption>Extraction of Methods in "AppController" for Code Reuse</figcaption>
</figure>
...
private void onOpenWDMenuItemAction() {
    if (Desktop.isDesktopSupported()) {
        ...
        catch (IOException &vert; UnsupportedOperationException e) {
            setStatus(e.getMessage());
        }
    }
    else {
...
private void onAboutMenuItemAction() {
    var alert = new Alert(
        ...
        &quot;Slides App &vert; blog &vert; mathsoftware.engineer&quot;,
        ButtonType.CLOSE
    );
...
<figcaption>Implementation of Menu Events</figcaption>
</figure>
...
<figcaption>Project Package Refactorization</figcaption>
</figure>
...
<figcaption>Project Module After Refactorization</figcaption>
</figure>
...
<figure>
    <img src="images/view-pagination-in-sync-with-list-view.png" alt="View Pagination in Sync with List View" />
    <figcaption>View Pagination in Sync with List View</figcaption>
</figure>
...
<figcaption>Pagination Implementation</figcaption>
</figure>
...
<div class="header user-select-none ">
    ...
    <div class="menu">
        <button type="button" data-path="slides---ep/src/main/java/engineer/mathsoftware/blog/slides/Slide.java" onclick="onOpenCodeSnippetLink(this)">
    <span class="material-symbols-rounded">
    open_in_new
    </span>
</button>

        <button type="button" data-code="public sealed interface Slide {
...
<figcaption>Application "Slide" Sum Type</figcaption>
</figure>
...
<div class="header user-select-none ">
    ...
    <div class="menu">
        <button type="button" data-path="slides---ep/src/main/java/engineer/mathsoftware/blog/slides/SlideItem.java" onclick="onOpenCodeSnippetLink(this)">
    <span class="material-symbols-rounded">
    open_in_new
    </span>
</button>

        <button type="button" data-code="public enum SlideItem {
    CodeSnippet,
    CodeShot,
    Screenshot
}
...
<figcaption>Application "SlideItem" Sum Type</figcaption>
</figure>
...
<div class="header user-select-none ">
    ...
    <div class="menu">
        <button type="button" data-path="slides---ep/src/main/java/engineer/mathsoftware/blog/slides/Language.java" onclick="onOpenCodeSnippetLink(this)">
    <span class="material-symbols-rounded">
    open_in_new
    </span>
</button>

        <button type="button" data-code="public enum Language {
    CSharp,
    CSS,
    Golang,
    Haskell,
...
<figcaption>Application Language Support</figcaption>
</figure>
...
<div class="header user-select-none ">
    ...
    <div class="menu">
        <button type="button" data-path="slides---ep/src/main/java/engineer/mathsoftware/blog/slides/Palette.java" onclick="onOpenCodeSnippetLink(this)">
    <span class="material-symbols-rounded">
    open_in_new
    </span>
</button>

        <button type="button" data-code="public enum Palette {
    Good(&quot;#4caf50&quot;),
    Error(&quot;#b00020&quot;);
...
<figcaption>Application Basic Color Palette</figcaption>
</figure>
...
<div class="header user-select-none ">
    ...
    <div class="menu">
        <button type="button" data-path="slides---ep/src/main/java/engineer/mathsoftware/blog/slides/Colors.java" onclick="onOpenCodeSnippetLink(this)">
    <span class="material-symbols-rounded">
    open_in_new
    </span>
</button>

        <button type="button" data-code="public final class Colors {
...
<figcaption>Utility Class "Colors"</figcaption>
</figure>
...
<div class="header user-select-none ">
    ...
    <div class="menu">
        <button type="button" data-path="slides---ep/src/main/java/engineer/mathsoftware/blog/slides/SlideSize.java" onclick="onOpenCodeSnippetLink(this)">
    <span class="material-symbols-rounded">
    open_in_new
    </span>
</button>

        <button type="button" data-code="public record SlideSize(double width, double height) {
...
<figcaption>Establishing Slide Resolutions</figcaption>
</figure>
...
<div class="header user-select-none ">
    ...
    <div class="menu">
        <button type="button" data-path="slides---ep/src/main/java/engineer/mathsoftware/blog/slides/PresentationConfig.java" onclick="onOpenCodeSnippetLink(this)">
    <span class="material-symbols-rounded">
    open_in_new
    </span>
</button>

        <button type="button" data-code="public record PresentationConfig(SlideSize size, Path savePath) {}
" onclick="onCopyCodeSnippet(this)">
            <span class="material-symbols-rounded">
            content_copy
            </span>
...
<figcaption>Presentation Configuration</figcaption>
</figure>
...
<div class="header user-select-none ">
    ...
    <div class="menu">
        <button type="button" data-path="slides---ep/src/main/java/engineer/mathsoftware/blog/slides/Enums.java" onclick="onOpenCodeSnippetLink(this)">
    <span class="material-symbols-rounded">
    open_in_new
    </span>
</button>

        <button type="button" data-code="public final class Enums {
...
<figcaption>Utility Class "Enums"</figcaption>
</figure>
...
<figure>
    <img src="detail-pane.png" alt="Detail Pane" />
    <figcaption>Detail Pane</figcaption>
</figure>
...
<div class="header user-select-none ">
    ...
    open_in_new
        ...
        <button type="button" data-code=".title {
    -fx-font-weight: bold;
}
" onclick="onCopyCodeSnippet(this)">
            <span class="material-symbols-rounded">
...
<figcaption>Class "title" for Bold Text</figcaption>
</figure>
...
<div class="header user-select-none ">
    ...
    open_in_new
        ...
        <button type="button" data-code="@FXML private ComboBox&lt;SlideItem&gt; slideComboBox;
...
<figcaption>Initialization of the Detail Pane</figcaption>
</figure>
...
<figure>
    <img src="images/screenshot-slide-view-drawing.png" alt="Screenshot Slide View Drawing" />
    <figcaption>Screenshot Slide View Drawing</figcaption>
</figure>
...
<div class="header user-select-none ">
    ...
    <div class="menu">
        <button type="button" data-path="slides---ep/src/main/java/engineer/mathsoftware/blog/slides/drawing/SlideDrawing.java" onclick="onOpenCodeSnippetLink(this)">
    <span class="material-symbols-rounded">
    open_in_new
    </span>
</button>

        <button type="button" data-code="public interface SlideDrawing {
...
<figcaption>Definition of "SlideDrawing"</figcaption>
</figure>
...
<div class="header user-select-none ">
    ...
    <div class="menu">
        <button type="button" data-path="slides---ep/src/main/java/engineer/mathsoftware/blog/slides/drawing/GroupSlideDrawing.java" onclick="onOpenCodeSnippetLink(this)">
    <span class="material-symbols-rounded">
    open_in_new
    </span>
</button>

        <button type="button" data-code="public class GroupSlideDrawing implements SlideDrawing {
    private final HBox view;
...
<figcaption>Initial Implementation of "SlideDrawing" Based on a "Group" Parent</figcaption>
</figure>
...
<div class="header user-select-none ">
    ...
    open_in_new
        ...
        <button type="button" data-code="private Group drawScreenshot(Slide.Screenshot screenshot) {
    var group = new Group();
...
<figcaption>Drawing of a Screenshot Slide</figcaption>
</figure>
...
private void fitImageView(ImageView iv, Image originalImage) {
    ...
    if (size.width() &lt; w &vert;&vert; size.height() &lt; h) {
        if (size.width() &lt; w) {
...
<figcaption>Fitting the Image Size into the Drawing Group</figcaption>
</figure>
...
<div class="header user-select-none ">
    ...
    <div class="menu">
        <button type="button" data-path="slides---ep/src/main/java/engineer/mathsoftware/blog/slides/ui/SlideDrawingView.java" onclick="onOpenCodeSnippetLink(this)">
    <span class="material-symbols-rounded">
    open_in_new
    </span>
</button>

        <button type="button" data-code="class SlideDrawingView {
...
<figcaption>Implementation of "SlideDrawingView"</figcaption>
</figure>
...
<div class="header user-select-none ">
    ...
    open_in_new
        ...
        <button type="button" data-code="private final Map&lt;ImageItem, SlideDrawingView.SlideState&gt; changes;
...
<figcaption>Integration of the Drawing View into the Controller</figcaption>
</figure>
...
<figure>
    <img src="images/code-snippet-slide.png" alt="Code Snippet Slide" />
    <figcaption>Code Snippet Slide</figcaption>
</figure>
...
<figure>
    <img src="images/code-snippet-slide-for-many-languages.png" alt="Code Snippet Slide for Many Languages" />
    <figcaption>Code Snippet Slide for Many Languages</figcaption>
</figure>
...
<figure>
    <img src="images/new-button-for-empty-slides.png" alt="New Button for Empty Slides" />
    <figcaption>New Button for Empty Slides</figcaption>
</figure>

<figure>
    <img src="images/creating-a-new-slide.png" alt="Creating a New Slide" />
    <figcaption>Creating a New Slide</figcaption>
</figure>
...
<figure>
    <img src="images/new-slide-created.png" alt="New Slide Created" />
    <figcaption>New Slide Created</figcaption>
</figure>
...
<div class="header user-select-none ">
    ...
    open_in_new
        ...
        <button type="button" data-code="void createOrUpdateImage(ImageItem item) throws IOException;
" onclick="onCopyCodeSnippet(this)">
            <span class="material-symbols-rounded">
            content_copy
            </span>
...
<figcaption>Definition of Method to Add an Image Object to the Data Repository</figcaption>
</figure>
...
<div class="header user-select-none ">
    ...
    open_in_new
        ...
        <button type="button" data-code="@Override
...
<figcaption>Implementation of "createOrUpdateImage" into "LocalDataRepository"</figcaption>
</figure>
...
<figcaption>Implementation of Button to Create New Slides</figcaption>
</figure>
...
<figcaption>Adding the Language to a Slide and the Caption Record</figcaption>
</figure>
...
<figure>
    <img src="images/code-shot-slide.png" alt="Code Shot Slide" />
    <figcaption>Code Shot Slide</figcaption>
</figure>
...
<div class="header user-select-none ">
    ...
    open_in_new
        ...
        <button type="button" data-code="private Group drawCodeShot(Slide.CodeShot codeShot) {
    &#x2F;* ... *&#x2F;
...
<figcaption>Code Shot Slide Implementation</figcaption>
</figure>
...
<div class="header user-select-none ">
    ...
    <div class="menu">
        <button type="button" data-path="slides---ep/src/main/java/engineer/mathsoftware/blog/slides/lang/Element.java" onclick="onOpenCodeSnippetLink(this)">
    <span class="material-symbols-rounded">
    open_in_new
    </span>
</button>

        <button type="button" data-code="public sealed interface Element extends Enums.ToEnum&lt;ElementItem&gt; {
...
<figcaption>Definition of Language Elements</figcaption>
</figure>
...
<div class="header user-select-none ">
    ...
    open_in_new
        ...
        <button type="button" data-code="public interface ToEnum&lt;T extends Enum&lt;T&gt;&gt; {
    Class&lt;T&gt; enumType();
...
<figcaption>Type "ToEnum" that Allows to Convert an Object to an Enum Type</figcaption>
</figure>
...
<div class="header user-select-none ">
    ...
    <div class="menu">
        <button type="button" data-path="slides---ep/src/main/java/engineer/mathsoftware/blog/slides/lang/ElementItem.java" onclick="onOpenCodeSnippetLink(this)">
    <span class="material-symbols-rounded">
    open_in_new
    </span>
</button>

        <button type="button" data-code="public enum ElementItem {
    Keyword,
    Symbol,
    Type,
    Number,
...
<figcaption>Enum Sum Type "ElementItem" to Complement the "Element" Interface Sum Type</figcaption>
</figure>
...
<div class="header user-select-none ">
    ...
    <div class="menu">
        <button type="button" data-path="slides---ep/src/main/java/engineer/mathsoftware/blog/slides/lang/Spec.java" onclick="onOpenCodeSnippetLink(this)">
    <span class="material-symbols-rounded">
    open_in_new
    </span>
</button>

        <button type="button" data-code="public static Class&lt;? extends Enum&lt;?&gt;&gt; keywordTypeOf(Language language) {
...
<figcaption>Definitions of Language Keywords</figcaption>
</figure>
...
<div class="header user-select-none ">
    ...
    <div class="menu">
        <button type="button" data-path="slides---ep/src/main/java/engineer/mathsoftware/blog/slides/lang/SchemeColors.java" onclick="onOpenCodeSnippetLink(this)">
    <span class="material-symbols-rounded">
    open_in_new
    </span>
</button>

        <button type="button" data-code="public final class SchemeColors {
...
<figcaption>Definitions of Language Element Colors</figcaption>
</figure>
...
<div class="header user-select-none ">
    ...
    <div class="menu">
        <button type="button" data-path="slides---ep/src/main/java/engineer/mathsoftware/blog/slides/lang/Parser.java" onclick="onOpenCodeSnippetLink(this)">
    <span class="material-symbols-rounded">
    open_in_new
    </span>
</button>

        <button type="button" data-code="private static final Pattern STRING_PATTERN
    = Pattern
    .compile(&quot;([&#x27;\&quot;])([^&#x27;\&quot;]*)([&#x27;\&quot;])&quot;);
...
public static List&lt;String&gt; tokens(String code){
    ...
    var delimiterPatterns
        ...
        .collect(Collectors.joining(&quot;&vert;&quot;));
    var delimiterPattern
        = &quot;(?&lt;=&quot; + delimiterPatterns + &quot;)&vert;(?=&quot; + delimiterPatterns + &quot;)&quot;;
    &#x2F;* ... *&#x2F;
}
" onclick="onCopyCodeSnippet(this)">
            <span class="material-symbols-rounded">
...
<figcaption>Regex Used to Parse Language Elements</figcaption>
</figure>
...
<div class="header user-select-none ">
    ...
    <div class="menu">
        <button type="button" data-path="slides---ep/src/main/java/engineer/mathsoftware/blog/slides/drawing/CodeSnippetDrawing.java" onclick="onOpenCodeSnippetLink(this)">
    <span class="material-symbols-rounded">
    open_in_new
    </span>
</button>

        <button type="button" data-code="class CodeSnippetDrawing {
...
<figcaption>Implementation of the Code Snippet Drawing</figcaption>
</figure>
...
<div class="header user-select-none ">
    ...
    <div class="menu">
        <button type="button" data-path="slides---ep/src/main/java/engineer/mathsoftware/blog/slides/drawing/CaptionRenderer.java" onclick="onOpenCodeSnippetLink(this)">
    <span class="material-symbols-rounded">
    open_in_new
    </span>
</button>

        <button type="button" data-code="class CaptionRenderer {
...
<figcaption>Implementation of the Caption Drawing</figcaption>
</figure>
...
<figure>
    <img src="images/drawing-shapes.png" alt="Drawing Shapes" />
    <figcaption>Drawing Shapes</figcaption>
</figure>
...
<div class="header user-select-none ">
    ...
    <div class="menu">
        <button type="button" data-path="slides---ep/src/main/java/engineer/mathsoftware/blog/slides/ShapeItem.java" onclick="onOpenCodeSnippetLink(this)">
    <span class="material-symbols-rounded">
    open_in_new
    </span>
</button>

        <button type="button" data-code="public enum ShapeItem {
    Line,
    Rectangle,
    Circle
}
...
<figcaption>Defining the App Shapes Sum Type</figcaption>
</figure>
...
<div class="header user-select-none ">
    ...
    open_in_new
        ...
        <button type="button" data-code="@FXML private ComboBox&lt;ShapeItem&gt; shapeComboBox;
...
<figcaption>Implementing the Shapes UI</figcaption>
</figure>
...
<div class="header user-select-none ">
    ...
    open_in_new
        ...
        <button type="button" data-code="private final SlideDrawingController controller;
...
<figcaption>Adapting a new Controller for Drawing on Slides</figcaption>
</figure>
...
<div class="header user-select-none ">
    ...
    <div class="menu">
        <button type="button" data-path="slides---ep/src/main/java/engineer/mathsoftware/blog/slides/ui/SlideDrawingController.java" onclick="onOpenCodeSnippetLink(this)">
    <span class="material-symbols-rounded">
    open_in_new
    </span>
</button>

        <button type="button" data-code="class SlideDrawingController {
...
<figcaption>Handling Drawings on Top of Slides</figcaption>
</figure>
...
<div class="header user-select-none ">
    <div class="caption">
        ShapeRenderer.java | package drawing
    </div>

    <div class="menu">
        <button type="button" data-path="slides---ep/src/main/java/engineer/mathsoftware/blog/slides/drawing/ShapeRenderer.java" onclick="onOpenCodeSnippetLink(this)">
    <span class="material-symbols-rounded">
    open_in_new
    </span>
</button>

        <button type="button" data-code="public class ShapeRenderer {
...
<figcaption>Implementing Rendering of Shapes</figcaption>
</figure>
...
<figure>
    ...
    <figcaption>Drawing Shapes on Slides</figcaption>
</figure>
...
<figure>
    <img src="images/ocr-word-selection.png" alt="OCR Word Selection" />
    <figcaption>OCR Word Selection</figcaption>
</figure>
...
<figure>
    <img src="images/intellij-_-adding-the-tesseract-for-java-lib.png" alt="IntelliJ : Adding the Tesseract for Java Lib" />
    <figcaption>IntelliJ : Adding the Tesseract for Java Lib</figcaption>
</figure>
...
<figcaption>Requiring "tess4j" in the Project Java Module</figcaption>
</figure>
...
<figcaption>Creating the AI Package</figcaption>
</figure>
...
<figcaption>Creating a Drawing Package Special for AI Shapes</figcaption>
</figure>
...
<div class="header user-select-none ">
    <div class="caption">
        class Ocr | package ai
    </div>

    <div class="menu">
        <button type="button" data-path="slides---ep/src/main/java/engineer/mathsoftware/blog/slides/ai/Ocr.java" onclick="onOpenCodeSnippetLink(this)">
    <span class="material-symbols-rounded">
    open_in_new
    </span>
</button>

        <button type="button" data-code="static List&lt;BoundingBox&gt; textBoxes(Image image) {
...
<figcaption>Reading Word Boxes from an Image</figcaption>
</figure>
...
<div class="header user-select-none ">
    <div class="caption">
        interface SlideAI | package ai
    </div>

    <div class="menu">
        <button type="button" data-path="slides---ep/src/main/java/engineer/mathsoftware/blog/slides/ai/SlideAI.java" onclick="onOpenCodeSnippetLink(this)">
    <span class="material-symbols-rounded">
    open_in_new
    </span>
</button>

        <button type="button" data-code="public sealed interface SlideAI {
...
<figcaption>AI Supported by the App</figcaption>
</figure>
...
<div class="header user-select-none ">
    ...
    <div class="menu">
        ...
        <button type="button" data-code="public interface AIDrawing {
...
<figcaption>Defining the Structure of an AI Drawing</figcaption>
</figure>
...
<div class="header user-select-none headerless">
    ...
    <div class="menu">
        ...
        <button type="button" data-code="public sealed interface AIShape {
...
<figcaption>Defining the AI Shapes Required</figcaption>
</figure>
...
<figcaption>Stateful AI</figcaption>
</figure>
...
<div class="header user-select-none ">
    ...
    <div class="menu">
        ...
        <button type="button" data-code="public class GroupAIDrawing implements AIDrawing {
    private final Group group;
    private AIShape ai;
...
<figcaption>AI Drawing Implementation</figcaption>
</figure>
...
<div class="header user-select-none ">
    ...
    <div class="menu">
        <button type="button" data-path="slides---ep/src/main/java/engineer/mathsoftware/blog/slides/ui/AIController.java" onclick="onOpenCodeSnippetLink(this)">
    <span class="material-symbols-rounded">
    open_in_new
    </span>
</button>

        <button type="button" data-code="private final ObjectProperty&lt;OcrWordDetection&gt; wordDetectionProperty;
private Group group;
...
<figcaption>Initial OCR Integration on the JavaFX App</figcaption>
</figure>
...
<div class="header user-select-none ">
    ...
    open_in_new
        ...
        <button type="button" data-code="private final AIInvalidation aiInvalidation;
...
<div class="abstract">Optimizing Redundant Model Inference</div>

<figcaption>AI Invalidation Handling</figcaption>
</figure>
...
<div class="header user-select-none ">
    ...
    <div class="menu">
        <button type="button" data-path="slides---ep/src/main/java/engineer/mathsoftware/blog/slides/ui/SlideAIView.java" onclick="onOpenCodeSnippetLink(this)">
    <span class="material-symbols-rounded">
    open_in_new
    </span>
</button>

        <button type="button" data-code="private final ObjectProperty&lt;WordSelection&gt; wordSelectionProperty;
...
<figcaption>AI Mouse Event Detection</figcaption>
</figure>
...
<div class="header user-select-none ">
    ...
    open_in_new
        ...
        <button type="button" data-code="private void bindEvents(){
...
<div class="header user-select-none ">
    ...
    open_in_new
        ...
        <button type="button" data-code="Optional&lt;Line&gt; onMouseClicked() {
    &#x2F;&#x2F; ... &#x2F;&#x2F;
    var sel = wordSelectionProperty.get();
    var focus = sel.wordFocus();
    &#x2F;&#x2F; ... &#x2F;&#x2F;
...
<figcaption>Implementing Word Underlining</figcaption>
</figure>
...
<figcaption>Underlining a Word when Clicked</figcaption>
</figure>
...
<div class="header user-select-none ">
    ...
    open_in_new
        ...
        <button type="button" data-code="private final List&lt;BoundingBox&gt; aiBoxes;
...
<div class="abstract">Adding Lines in the Same Row</div>

<figcaption>Clever Underlining</figcaption>
</figure>
...
<figure>
    <img src="images/clear-ai-lines-commit.png" alt="Clear AI Lines Commit" />
    <figcaption>Clear AI Lines Commit</figcaption>
</figure>
...
<figure>
    ...
    <figcaption>OCR Word Detection for Automated Underlining</figcaption>
</figure>
...
<figure>
    ...
    <figcaption>OCR Side Effects</figcaption>
</figure>
...
<div class="header user-select-none ">
    <div class="caption">
        class Env | package data
    </div>

    <div class="menu">
        <button type="button" data-path="slides---ep/src/main/java/engineer/mathsoftware/blog/slides/data/Env.java" onclick="onOpenCodeSnippetLink(this)">
    <span class="material-symbols-rounded">
    open_in_new
    </span>
</button>

        <button type="button" data-code="public static final String DATA_ROOT = &quot;data&quot;;
...
<div class="header user-select-none headerless">
    ...
    <div class="menu">
        ...
        <button type="button" data-code="class AutoSave {
    private final DataRepository repository;
...
<figcaption>Auto Save Implementation</figcaption>
</figure>
...
<figure>
    <img src="auto-save-menu-item.png" alt="Auto Save Menu Item" />
    <figcaption>Auto Save Menu Item</figcaption>
</figure>
...
<div class="header user-select-none ">
    ...
    <div class="menu">
        <button type="button" data-path="slides---ep/src/main/java/engineer/mathsoftware/blog/slides/ui/AutoSave.java" onclick="onOpenCodeSnippetLink(this)">
    <span class="material-symbols-rounded">
    open_in_new
    </span>
</button>

        <button type="button" data-code="private static class SaveInvalidation {
    ...
    void validateLater() {
        if (!isInvalid &vert;&vert; !isEnabled) {
            return;
        }
...
<figcaption>Save Invalidation FSM</figcaption>
</figure>
